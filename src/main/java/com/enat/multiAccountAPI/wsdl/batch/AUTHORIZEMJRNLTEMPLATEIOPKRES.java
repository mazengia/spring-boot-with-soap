 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Detms-Jrnl-Tmpl-Master-PK" type="{http://fcubs.ofss.com/service/FCUBSDEService}MultiJrnlTeml-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Detms-Jrnl-Tmpl-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSDEService}MultiJrnlTeml-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZEMJRNLTEMPLATE_IOPK_RES")
public class AUTHORIZEMJRNLTEMPLATEIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZEMJRNLTEMPLATEIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZEMJRNLTEMPLATEIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZEMJRNLTEMPLATEIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZEMJRNLTEMPLATEIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Detms-Jrnl-Tmpl-Master-PK")
        protected MultiJrnlTemlPKType detmsJrnlTmplMasterPK;
        ...
        /**
         * Gets the value of the detmsJrnlTmplMasterPK property.
         * 
         * @return
         *     possible object is
         *     {@link MultiJrnlTemlPKType }
         *     
         */
        public MultiJrnlTemlPKType getDetmsJrnlTmplMasterPK() {
            return detmsJrnlTmplMasterPK;
        }

        /**
         * Sets the value of the detmsJrnlTmplMasterPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link MultiJrnlTemlPKType }
         *     
         */
        public void setDetmsJrnlTmplMasterPK(MultiJrnlTemlPKType value) {
            this.detmsJrnlTmplMasterPK = value;
        }
