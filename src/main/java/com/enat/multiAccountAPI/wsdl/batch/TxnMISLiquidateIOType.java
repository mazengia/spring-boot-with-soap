...
public class TxnMISLiquidateIOType {
    ...
    protected List<TxnMISLiquidateIOType.Txnmisdetails> txnmisdetails;
    @XmlElement(name = "Compmisdetails", required = true)
    protected List<TxnMISLiquidateIOType.Compmisdetails> compmisdetails;
    @XmlElement(name = "Fundmisdetails", required = true)
    protected List<TxnMISLiquidateIOType.Fundmisdetails> fundmisdetails;
     ...
     * {@link TxnMISLiquidateIOType.Txnmisdetails }
     * 
     * 
     */
    public List<TxnMISLiquidateIOType.Txnmisdetails> getTxnmisdetails() {
        if (txnmisdetails == null) {
            txnmisdetails = new ArrayList<TxnMISLiquidateIOType.Txnmisdetails>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TxnMISLiquidateIOType.Compmisdetails }
     * 
     * 
     */
    public List<TxnMISLiquidateIOType.Compmisdetails> getCompmisdetails() {
        if (compmisdetails == null) {
            compmisdetails = new ArrayList<TxnMISLiquidateIOType.Compmisdetails>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TxnMISLiquidateIOType.Fundmisdetails }
     * 
     * 
     */
    public List<TxnMISLiquidateIOType.Fundmisdetails> getFundmisdetails() {
        if (fundmisdetails == null) {
            fundmisdetails = new ArrayList<TxnMISLiquidateIOType.Fundmisdetails>();
        }
