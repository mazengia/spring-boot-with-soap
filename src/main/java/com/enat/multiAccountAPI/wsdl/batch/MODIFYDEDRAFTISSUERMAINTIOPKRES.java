 ...
 *                   &lt;element name="Detms-Mck-Issuer-Codes-IO" type="{http://fcubs.ofss.com/service/FCUBSDEService}DEDraftIssuerMaint-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYDEDRAFTISSUERMAINT_IOPK_RES")
public class MODIFYDEDRAFTISSUERMAINTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYDEDRAFTISSUERMAINTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYDEDRAFTISSUERMAINTIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYDEDRAFTISSUERMAINTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYDEDRAFTISSUERMAINTIOPKRES.FCUBSBODY value) {
