 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Multi-Offset-Auth" type="{http://fcubs.ofss.com/service/FCUBSDEService}Detbs_Multi_Auth_InputFullType"/&gt;
...
@XmlRootElement(name = "MULTIAUTHORIZE_FSFS_RES")
public class MULTIAUTHORIZEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MULTIAUTHORIZEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MULTIAUTHORIZEFSFSRES.FCUBSBODY }
     *     
     */
    public MULTIAUTHORIZEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MULTIAUTHORIZEFSFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Multi-Offset-Auth", required = true)
        protected DetbsMultiAuthInputFullType multiOffsetAuth;
        ...
        /**
         * Gets the value of the multiOffsetAuth property.
         * 
         * @return
         *     possible object is
         *     {@link DetbsMultiAuthInputFullType }
         *     
         */
        public DetbsMultiAuthInputFullType getMultiOffsetAuth() {
            return multiOffsetAuth;
        }

        /**
         * Sets the value of the multiOffsetAuth property.
         * 
         * @param value
         *     allowed object is
         *     {@link DetbsMultiAuthInputFullType }
         *     
         */
        public void setMultiOffsetAuth(DetbsMultiAuthInputFullType value) {
            this.multiOffsetAuth = value;
        }
