 ...
 *                   &lt;element name="Detms-Jrnl-Tmpl-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSDEService}MultiJrnlTeml-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSEMJRNLTEMPLATE_IOPK_RES")
public class CLOSEMJRNLTEMPLATEIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSEMJRNLTEMPLATEIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSEMJRNLTEMPLATEIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSEMJRNLTEMPLATEIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSEMJRNLTEMPLATEIOPKRES.FCUBSBODY value) {
