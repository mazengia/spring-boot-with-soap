 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Catb-Archival-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ChqArchival-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Catb-Archival-Master-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}ChqArchival-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCHQARCHIVAL_IOFS_RES")
public class QUERYCHQARCHIVALIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYCHQARCHIVALIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYCHQARCHIVALIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYCHQARCHIVALIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYCHQARCHIVALIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected ChqArchivalQueryIOType catbArchivalMasterIO;
        @XmlElement(name = "Catb-Archival-Master-Full")
        protected ChqArchivalFullType catbArchivalMasterFull;
         ...
         * @return
         *     possible object is
         *     {@link ChqArchivalQueryIOType }
         *     
         */
        public ChqArchivalQueryIOType getCatbArchivalMasterIO() {
         ...
         *     
         */
        public void setCatbArchivalMasterIO(ChqArchivalQueryIOType value) {
            this.catbArchivalMasterIO = value;
        }

        /**
         * Gets the value of the catbArchivalMasterFull property.
         * 
         * @return
         *     possible object is
         *     {@link ChqArchivalFullType }
         *     
         */
        public ChqArchivalFullType getCatbArchivalMasterFull() {
            return catbArchivalMasterFull;
        }

        /**
         * Sets the value of the catbArchivalMasterFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ChqArchivalFullType }
         *     
         */
        public void setCatbArchivalMasterFull(ChqArchivalFullType value) {
            this.catbArchivalMasterFull = value;
        }
