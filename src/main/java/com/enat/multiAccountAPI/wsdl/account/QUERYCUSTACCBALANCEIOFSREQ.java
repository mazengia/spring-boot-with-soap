 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Acvws-Acdcbird-Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAccBalance-Query-IO-Type"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlRootElement(name = "QUERYCUSTACCBALANCE_IOFS_REQ")
public class QUERYCUSTACCBALANCEIOFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYCUSTACCBALANCEIOFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYCUSTACCBALANCEIOFSREQ.FCUBSBODY }
     *     
     */
    public QUERYCUSTACCBALANCEIOFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYCUSTACCBALANCEIOFSREQ.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Acvws-Acdcbird-Cust-Account-IO", required = true)
