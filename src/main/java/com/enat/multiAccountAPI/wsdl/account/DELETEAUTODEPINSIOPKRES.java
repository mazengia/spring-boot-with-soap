 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Ictb-Deposit-Instruction-PK" type="{http://fcubs.ofss.com/service/FCUBSAccService}AutoDepIns-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Ictb-Deposit-Instruction-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}AutoDepIns-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETEAUTODEPINS_IOPK_RES")
public class DELETEAUTODEPINSIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEAUTODEPINSIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEAUTODEPINSIOPKRES.FCUBSBODY }
     *     
     */
    public DELETEAUTODEPINSIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEAUTODEPINSIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Ictb-Deposit-Instruction-PK")
        protected AutoDepInsPKType ictbDepositInstructionPK;
        @XmlElement(name = "Ictb-Deposit-Instruction-IO")
        protected AutoDepInsDeleteIOType ictbDepositInstructionIO;
        ...
        /**
         * Gets the value of the ictbDepositInstructionPK property.
         * 
         * @return
         *     possible object is
         *     {@link AutoDepInsPKType }
         *     
         */
        public AutoDepInsPKType getIctbDepositInstructionPK() {
            return ictbDepositInstructionPK;
        }

        /**
         * Sets the value of the ictbDepositInstructionPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link AutoDepInsPKType }
         *     
         */
        public void setIctbDepositInstructionPK(AutoDepInsPKType value) {
            this.ictbDepositInstructionPK = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link AutoDepInsDeleteIOType }
         *     
         */
        public AutoDepInsDeleteIOType getIctbDepositInstructionIO() {
         ...
         *     
         */
        public void setIctbDepositInstructionIO(AutoDepInsDeleteIOType value) {
