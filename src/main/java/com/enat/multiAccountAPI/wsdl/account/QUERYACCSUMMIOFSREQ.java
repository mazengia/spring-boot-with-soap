 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Stvw-Account-Sumary-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}QueryAccSumm-Query-IO-Type"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlRootElement(name = "QUERYACCSUMM_IOFS_REQ")
public class QUERYACCSUMMIOFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYACCSUMMIOFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYACCSUMMIOFSREQ.FCUBSBODY }
     *     
     */
    public QUERYACCSUMMIOFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYACCSUMMIOFSREQ.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Stvw-Account-Sumary-IO", required = true)
