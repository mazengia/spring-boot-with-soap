 ...
 *                   &lt;element name="Chq-Bk-Details-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CheckBook-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZECHECKBOOK_IOPK_RES")
public class AUTHORIZECHECKBOOKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECHECKBOOKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECHECKBOOKIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECHECKBOOKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECHECKBOOKIOPKRES.FCUBSBODY value) {
