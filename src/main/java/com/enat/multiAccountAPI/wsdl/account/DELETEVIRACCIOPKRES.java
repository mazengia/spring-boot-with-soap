 ...
 *                   &lt;element name="Virtual-Acc-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}VirAcc-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETEVIRACC_IOPK_RES")
public class DELETEVIRACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEVIRACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEVIRACCIOPKRES.FCUBSBODY }
     *     
     */
    public DELETEVIRACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEVIRACCIOPKRES.FCUBSBODY value) {
