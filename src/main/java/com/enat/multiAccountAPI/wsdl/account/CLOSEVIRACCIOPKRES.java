 ...
 *                   &lt;element name="Virtual-Acc-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}VirAcc-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSEVIRACC_IOPK_RES")
public class CLOSEVIRACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSEVIRACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSEVIRACCIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSEVIRACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSEVIRACCIOPKRES.FCUBSBODY value) {
