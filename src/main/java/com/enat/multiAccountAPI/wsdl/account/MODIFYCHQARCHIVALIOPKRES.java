 ...
 *                   &lt;element name="Catb-Archival-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ChqArchival-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYCHQARCHIVAL_IOPK_RES")
public class MODIFYCHQARCHIVALIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCHQARCHIVALIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCHQARCHIVALIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYCHQARCHIVALIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCHQARCHIVALIOPKRES.FCUBSBODY value) {
