 ...
 *                   &lt;element name="Virtual-Acc-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}VirAcc-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATEVIRACC_IOPK_RES")
public class CREATEVIRACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEVIRACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEVIRACCIOPKRES.FCUBSBODY }
     *     
     */
    public CREATEVIRACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEVIRACCIOPKRES.FCUBSBODY value) {
