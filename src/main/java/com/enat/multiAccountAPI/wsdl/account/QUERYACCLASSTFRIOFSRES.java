 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Main-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAccTfr-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Main-Full" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAccTfr-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYACCLASSTFR_IOFS_RES")
public class QUERYACCLASSTFRIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYACCLASSTFRIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYACCLASSTFRIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYACCLASSTFRIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYACCLASSTFRIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustAccTfrQueryIOType mainIO;
        @XmlElement(name = "Main-Full")
         ...
         * @return
         *     possible object is
         *     {@link CustAccTfrQueryIOType }
         *     
         */
        public CustAccTfrQueryIOType getMainIO() {
            return mainIO;
        }
         ...
         *     
         */
        public void setMainIO(CustAccTfrQueryIOType value) {
            this.mainIO = value;
        }
