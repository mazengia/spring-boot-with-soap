 ...
 *                   &lt;element name="Main-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CbStmt-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSECBSTMT_IOPK_RES")
public class CLOSECBSTMTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECBSTMTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECBSTMTIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSECBSTMTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECBSTMTIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CbStmtCloseIOType mainIO;
         ...
         * @return
         *     possible object is
         *     {@link CbStmtCloseIOType }
         *     
         */
        public CbStmtCloseIOType getMainIO() {
            return mainIO;
        }
         ...
         *     
         */
        public void setMainIO(CbStmtCloseIOType value) {
            this.mainIO = value;
        }
