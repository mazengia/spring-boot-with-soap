 ...
 *                   &lt;element name="Catb-Archival-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ChqArchival-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZECHQARCHIVAL_IOPK_RES")
public class AUTHORIZECHQARCHIVALIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECHQARCHIVALIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECHQARCHIVALIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECHQARCHIVALIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECHQARCHIVALIOPKRES.FCUBSBODY value) {
