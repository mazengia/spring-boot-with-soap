...
/**
 * <p>Java class for AccAddrModifyType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AccAddrModifyType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="MSGADRESS" type="{http://fcubs.ofss.com/service/FCUBSAccService}MsgAddrsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AccAddrModifyType", propOrder = {
    "media",
    "loc",
    "lang",
    "name",
...
public class AccAddrModifyType {
    ...
    @XmlElement(name = "MSGADRESS")
    protected List<MsgAddrsType> msgadress;
    ...
    /**
     * Gets the value of the msgadress property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the msgadress property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMSGADRESS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MsgAddrsType> getMSGADRESS() {
        if (msgadress == null) {
            msgadress = new ArrayList<MsgAddrsType>();
        }
        return this.msgadress;
    }
