 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Chq-Bk-Details-PK" type="{http://fcubs.ofss.com/service/FCUBSAccService}CheckBook-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Chq-Bk-Details-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CheckBook-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETECHECKBOOK_IOPK_RES")
public class DELETECHECKBOOKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETECHECKBOOKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETECHECKBOOKIOPKRES.FCUBSBODY }
     *     
     */
    public DELETECHECKBOOKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETECHECKBOOKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Chq-Bk-Details-PK")
        protected CheckBookPKType chqBkDetailsPK;
        @XmlElement(name = "Chq-Bk-Details-IO")
        protected CheckBookDeleteIOType chqBkDetailsIO;
        ...
        /**
         * Gets the value of the chqBkDetailsPK property.
         * 
         * @return
         *     possible object is
         *     {@link CheckBookPKType }
         *     
         */
        public CheckBookPKType getChqBkDetailsPK() {
            return chqBkDetailsPK;
        }

        /**
         * Sets the value of the chqBkDetailsPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link CheckBookPKType }
         *     
         */
        public void setChqBkDetailsPK(CheckBookPKType value) {
            this.chqBkDetailsPK = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CheckBookDeleteIOType }
         *     
         */
        public CheckBookDeleteIOType getChqBkDetailsIO() {
         ...
         *     
         */
        public void setChqBkDetailsIO(CheckBookDeleteIOType value) {
