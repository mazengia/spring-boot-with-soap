 ...
 *                   &lt;element name="Tdtopup-Detail-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}TDTopUp-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZETDTOPUP_IOPK_RES")
public class AUTHORIZETDTOPUPIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZETDTOPUPIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZETDTOPUPIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZETDTOPUPIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZETDTOPUPIOPKRES.FCUBSBODY value) {
