 ...
 *                   &lt;element name="Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}TDCustAcc-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATETDCUSTACC_IOPK_RES")
public class CREATETDCUSTACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATETDCUSTACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATETDCUSTACCIOPKRES.FCUBSBODY }
     *     
     */
    public CREATETDCUSTACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATETDCUSTACCIOPKRES.FCUBSBODY value) {
