 ...
 *                   &lt;element name="Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAcc-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSECUSTACC_IOPK_RES")
public class CLOSECUSTACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTACCIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSECUSTACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTACCIOPKRES.FCUBSBODY value) {
