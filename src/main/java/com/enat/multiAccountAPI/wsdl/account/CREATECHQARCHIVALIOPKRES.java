 ...
 *                   &lt;element name="Catb-Archival-Master-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}ChqArchival-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATECHQARCHIVAL_IOPK_RES")
public class CREATECHQARCHIVALIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECHQARCHIVALIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECHQARCHIVALIOPKRES.FCUBSBODY }
     *     
     */
    public CREATECHQARCHIVALIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECHQARCHIVALIOPKRES.FCUBSBODY value) {
