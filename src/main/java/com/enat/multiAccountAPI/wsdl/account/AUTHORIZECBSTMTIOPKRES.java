 ...
 *                   &lt;element name="Main-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CbStmt-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZECBSTMT_IOPK_RES")
public class AUTHORIZECBSTMTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECBSTMTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECBSTMTIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECBSTMTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECBSTMTIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CbStmtAuthorizeIOType mainIO;
         ...
         * @return
         *     possible object is
         *     {@link CbStmtAuthorizeIOType }
         *     
         */
        public CbStmtAuthorizeIOType getMainIO() {
            return mainIO;
        }
         ...
         *     
         */
        public void setMainIO(CbStmtAuthorizeIOType value) {
            this.mainIO = value;
        }
