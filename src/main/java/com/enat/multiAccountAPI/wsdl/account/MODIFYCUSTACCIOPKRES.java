 ...
 *                   &lt;element name="Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CustAcc-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYCUSTACC_IOPK_RES")
public class MODIFYCUSTACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCUSTACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCUSTACCIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYCUSTACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCUSTACCIOPKRES.FCUBSBODY value) {
