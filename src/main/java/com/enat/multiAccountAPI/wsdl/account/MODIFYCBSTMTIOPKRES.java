 ...
 *                   &lt;element name="Main-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}CbStmt-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYCBSTMT_IOPK_RES")
public class MODIFYCBSTMTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCBSTMTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCBSTMTIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYCBSTMTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCBSTMTIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CbStmtModifyIOType mainIO;
         ...
         * @return
         *     possible object is
         *     {@link CbStmtModifyIOType }
         *     
         */
        public CbStmtModifyIOType getMainIO() {
            return mainIO;
        }
         ...
         *     
         */
        public void setMainIO(CbStmtModifyIOType value) {
            this.mainIO = value;
        }
