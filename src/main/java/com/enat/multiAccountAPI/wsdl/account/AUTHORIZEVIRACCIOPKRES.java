 ...
 *                   &lt;element name="Virtual-Acc-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}VirAcc-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZEVIRACC_IOPK_RES")
public class AUTHORIZEVIRACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZEVIRACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZEVIRACCIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZEVIRACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZEVIRACCIOPKRES.FCUBSBODY value) {
