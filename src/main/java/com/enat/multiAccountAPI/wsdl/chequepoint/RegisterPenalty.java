 ...
 *         &lt;element name="RegisterPenaltyRequest" type="{https://www.fintech-group.com/services/Finpay}UtilAPIRegisterPenaltyRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "token",
    "licenseNumber",
    "registerPenaltyRequest"
})
@XmlRootElement(name = "RegisterPenalty")
public class RegisterPenalty {
    ...
    @XmlElement(name = "RegisterPenaltyRequest")
    protected UtilAPIRegisterPenaltyRequest registerPenaltyRequest;
    ...
    /**
     * Gets the value of the registerPenaltyRequest property.
     * 
     * @return
     *     possible object is
     *     {@link UtilAPIRegisterPenaltyRequest }
     *     
     */
    public UtilAPIRegisterPenaltyRequest getRegisterPenaltyRequest() {
        return registerPenaltyRequest;
    }

    /**
     * Sets the value of the registerPenaltyRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link UtilAPIRegisterPenaltyRequest }
     *     
     */
    public void setRegisterPenaltyRequest(UtilAPIRegisterPenaltyRequest value) {
        this.registerPenaltyRequest = value;
    }
